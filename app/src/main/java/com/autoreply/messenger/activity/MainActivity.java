...
// Trong setupUI(), thêm sau b.etReplyText.setText(config.replyText);
    ...
    private void showEditSetDialog(int pos) {
        ...
        FlexboxLayout flexKw = v.findViewById(R.id.flex_kw);
        FlexboxLayout flexEx = v.findViewById(R.id.flex_ex);
        NestedScrollView scrollRoot = v.findViewById(R.id.scroll_root);
    ...
    private void populateChips(FlexboxLayout container,
